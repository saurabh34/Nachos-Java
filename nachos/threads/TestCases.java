...
public class TestCases {
	...
	public static void runTestCase2() {
	    KThread low     = new KThread(new Low1PriorityThread()).setName("Low1");
	    KThread med     = new KThread(new Medium1PriorityThread()).setName("Med1");
	    KThread high    = new KThread(new High1PriorityThread()).setName("High1");
	    KThread high2    = new KThread(new High1PriorityThread()).setName("High2"); 
	 ...
	 private static final char dbgThread = 't';
	    ...
	    private static class High1PriorityThread implements Runnable
	    { 	
	    	public void run()
	        {     
	    		for(int j=0;j<5;j++){
	    ...
	    private static class Medium1PriorityThread implements Runnable
	    {
	       public void run()
	        {
	          for (int j=0;j<10;j++) {   
	    ...
	    private static class Low1PriorityThread implements Runnable
	    {
	    	public void run()
	    	 {
	                for(int i = 0; i < 100; ++i)
